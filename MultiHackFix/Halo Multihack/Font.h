...
public:
    ...
    HRESULT DrawTextA( FLOAT x, FLOAT y, DWORD dwColor, CHAR* strText, DWORD dwFlags=0L );
    ...
    CD3DFont( CHAR* strFontName, DWORD dwHeight, DWORD dwFlags=0L );
    ~CD3DFont();
};

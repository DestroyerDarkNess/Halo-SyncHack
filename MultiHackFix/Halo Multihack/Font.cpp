...
//-------------------------------------------
CD3DFont::CD3DFont( CHAR* strFontName, DWORD dwHeight, DWORD dwFlags )
{
    strcpy_s( m_strFontName, strFontName );
...
//-------------------------------------------
HRESULT CD3DFont::GetTextExtent( CHAR* strText, SIZE* pSize )
{
...
// Desc: Draws 2D text
//-------------------------------------------
HRESULT CD3DFont::DrawTextA( FLOAT sx, FLOAT sy, DWORD dwColor, CHAR* strText, DWORD dwFlags )
{
